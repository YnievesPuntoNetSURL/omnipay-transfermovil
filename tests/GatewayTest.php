...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testInfo(): void
    {
        ...
        $this->assertInstanceOf('\Omnipay\Transfermovil\Message\ResponseInfo', $responseInfo);
    }
    ...
    public function testPurchase(): void
    {
        $responseInfo = $this->gateway
                             ...
                             ->send();
        $this->assertFalse($responseInfo->isSuccessful());
        $this->assertInstanceOf('\Omnipay\Transfermovil\Message\ResponseCreateInvoice', $responseInfo);
    }
